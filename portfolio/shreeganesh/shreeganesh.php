...
<body>
    ...
    <div class="container">
        ...
        <div class="row flex-center">
            ...
            <main class="card" id="card">
                ...
                <div class="card-header"><b style="color:red;">|| श्री गणेश प्रश्नावली यंत्र ||</b></div>
			...
			<span class="card-footer" id="footer">अपने मन मे प्रश्न को रख कर भगवान श्रीगणेश का स्मरण करते हुए प्रश्नावली चक्र पर से एक अंक का चयन कीजिये,उस अंक के फलादेश को ही अपने अपने प्रश्न का उत्तर समझें।</span>
    ...
    <div class="row flex-bottom flex-center">
        ...
        <footer>
            ...
            <p>A project by <a href="https://ptprashanttripathi.github.io/">@PtPrashantTripathi</a></p>
